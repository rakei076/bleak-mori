...
**路径1：快速了解**（15分钟）
1. 阅读本README
2. 阅读 `QUICK-REFERENCE.md`
3. 浏览两篇示例文章的开头部分

**路径2：深入学习**（1小时）
1. 完整阅读两篇示例文章
2. 对照阅读 `DETAILED-COMPARISON.md`
3. 深入研读 `analysis-report.md`

**路径3：实践应用**（根据需要）
1. 使用 `QUICK-REFERENCE.md` 中的检查清单
2. 参考 `analysis-report.md` 的实战案例
3. 练习改写，逐步掌握技巧
